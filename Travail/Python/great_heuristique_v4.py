...
execute = 30
t = "B-n57-k07"
instance,demand = read("toExecute/"+t+".xml")
...
record = [[0, 4, 29, 40, 35, 54], [0, 25, 28, 8, 9, 12, 53, 38, 36, 18], [0, 56, 26, 17, 34, 51, 19, 41], [0, 52, 50, 39, 14, 42, 22, 30, 2], [0, 32, 47, 20, 43, 7, 37, 55], [0, 5, 33, 13, 23, 46], [0, 27, 24, 3, 10, 21, 44, 49, 48, 16], [0, 45, 6, 31, 11, 15, 1]]
