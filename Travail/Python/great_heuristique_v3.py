...
initial_solution = ClarkeWright(A_n32_k05[0],A_n32_k05[1], lam)
for i in range(len(initial_solution)):
    initial_solution[i][0] = LK(initial_solution[i][0].copy(), A_n32_k05[0])
print_current_sol(initial_solution,A_n32_k05[0])
py.show()
E = common_edges(initial_solution,sol_A3205)
print(E)

print_instance(A_n32_k05[0])
print_edges(E,A_n32_k05[0])
py.show()
